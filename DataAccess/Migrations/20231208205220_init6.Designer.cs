...
namespace DataAccess.Migrations
{
    ...
    [Migration("20231208205220_init6")]
    partial class init6
    {
            ...
            modelBuilder.Entity("DataAccess.Models.InvestField", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7d1fe758-0e09-4562-84c5-3efc1b872756"),
                            Title = "Фінанси"
                        },
                        new
                        {
                            Id = new Guid("89973b11-d5f4-4a04-8b8e-52ad32e74bfb"),
                            Title = "Сільськогосподарська техніка"
                        },
                        new
                        {
                            Id = new Guid("80180973-ff9a-4585-8438-8159f880990c"),
                            Title = "Займи"
                        },
                        new
                        {
                            Id = new Guid("171d2a86-74f7-4a76-a9b1-3ce7a7ea4fdf"),
                            Title = "Лізинг Авто"
                        },
                        new
                        {
                            Id = new Guid("c2b9eabe-c3f6-4af9-9882-f509953be8f2"),
