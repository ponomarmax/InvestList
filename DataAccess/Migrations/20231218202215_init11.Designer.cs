...
namespace DataAccess.Migrations
{
    ...
    [Migration("20231218202215_init11")]
            ...
            modelBuilder.Entity("DataAccess.Models.InvestField", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d8469604-e87e-4ef9-b845-39e4e5e8e874"),
                            Title = "Фінанси"
                        },
                        new
                        {
                            Id = new Guid("83b888a7-9bcb-49d3-b067-52f00883e8d7"),
                            Title = "Сільськогосподарська техніка"
                        },
                        new
                        {
                            Id = new Guid("7320dcef-e544-451d-b415-4bc115c339a3"),
                            Title = "Займи"
                        },
                        new
                        {
                            Id = new Guid("328d780f-fec3-4564-838b-ed92388afc3b"),
                            Title = "Лізинг Авто"
                        },
                        new
                        {
                            Id = new Guid("0f4cf0e9-6b8e-4bea-8cc3-11707e6abccb"),
            ...
            modelBuilder.Entity("DataAccess.Models.Tag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("17c6100f-28b2-4e65-ac47-d2271d5e53f3"),
                            Name = "Шахраї"
                        },
                        new
                        {
                            Id = new Guid("dbc94b22-b28a-4e5d-8d2c-df8137080cf5"),
                            Name = "Цікавинка"
                        },
                        new
                        {
                            Id = new Guid("d9030443-5c02-4836-b8c5-3c01cef45a75"),
                            Name = "Сенсація"
                        });
                });
